...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> searchBookings(@Param("customerName") String customerName,
                                 ...
                                 @Param("stayType") StayType stayType);
    ...
    @Query("""
            ...
            where b.room = :room
              ...
              and (b.checkOutDate is null or b.checkOutDate > :checkInDate)
            """)
    long countOverlappingRoomBookings(Room room, List<BookingStatus> statuses, LocalDate checkInDate, LocalDate checkOutDate, Long excludeId);
